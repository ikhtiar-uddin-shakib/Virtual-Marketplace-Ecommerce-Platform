...
const Navbar = () => {
    const { collection } = UseCart(); // Destructure collection from the UseCart hook
    ...
    return (
        <div className="navbar bg-blue-100 py-5">
            ...
            <div className="navbar-end">
                ...
                <Link to='/addcart'>
                    <button className="btn bg-blue-800 text-white flex items-center">
                        <FaCartShopping className="mr-2" />
                        <div className="badge badge-secondary">+{collection.length}</div>
                    </button>
                </Link>
            </div>
        </div>
