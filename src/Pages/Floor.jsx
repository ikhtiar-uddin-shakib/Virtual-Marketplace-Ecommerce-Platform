...
const Floor = () => {
    ...
    }, [id, num, shoppingMalls]);

    console.log("Loaded data in Floor:", floor); // Debug logging
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 container mx-auto my-10">
                {
                    floor.shops.map((shop, idx) => (
                        <div key={idx} className="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
