  ...
  return (
    <div>
      <div className="text-start my-10 md:ml-10">
        <h1 className="container text-blue-950 mx-auto font-sedan text-4xl border-blue-950 border-l-8 pl-10 font-semibold  ">
          SHOP : <span className="font-rubik">{shop?.shopName}</span>
        </h1>
      </div>
          ...
          <div key={idx}>
            <div className="max-w-xs  overflow-hidden bg-blue-50 rounded-lg shadow-lg dark:bg-gray-800">
              <div className="px-4 py-2">
                <h1 className="text-xl font-bold text-blue-900 uppercase dark:text-white">
                  {product.productName}
                </h1>
