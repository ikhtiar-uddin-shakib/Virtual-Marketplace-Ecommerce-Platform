    ...
    return (
        <footer className="px-4 divide-y bg-black ">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-blue-500 t">Product</h3>
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-blue-500 ">Company</h3>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase dark:text-blue-500 ">Developers</h3>
                        <ul className="space-y-1">
                            <li>
                    ...
                    <div className="space-y-3">
                        <div className="uppercase dark:text-blue-500 ">Social media</div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">
                © 2026 <span className="font-sedan font-bold">ShopVista</span> 
